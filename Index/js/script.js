...
document.querySelector('.closeicon2').addEventListener('click', function(){
  document.querySelector('.bg2').style.display = 'none';
});


document.querySelector('.section3').addEventListener('click', function() {
  document.querySelector('.bg3').style.display = 'flex';
});

document.querySelector('.closeicon3').addEventListener('click', function(){
  document.querySelector('.bg3').style.display = 'none';
});


document.querySelector('.section5').addEventListener('click', function() {
  document.querySelector('.bg5').style.display = 'flex';
});

document.querySelector('.closeicon5').addEventListener('click', function(){
  document.querySelector('.bg5').style.display = 'none';
});
...
//end of first & third column components
...
// end of third column components
...
// end of fourth column components
...
// end of fifth column components
...
//end of sixth column components//
...
document.querySelector('.content-4').addEventListener('click', function() {
...
document.querySelector('.content-5').addEventListener('click', function() {
...
function drop(ev){
  ...
  var nodeCopy = document.getElementById(data).cloneNode(true); /*duplicate the item*/
  nodeCopy.id = "newId"; /* cannot use same id*/
  ev.target.appendChild(nodeCopy); /*duplicate the item*/
}
  ...
  $("#container").droppable({
    ...
    drop: function (event, ui) {
        ...
        $(this).append($(ui.draggable).cloneNode(true));
    }
  });

  function myFunction() {
  alert("This website is only to learn how to write your name in Korean language");
}
